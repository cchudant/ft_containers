...
/*   Updated: 2020/01/24 10:46:57 by cchudant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_vector()
{
    testOne("push_back", test_pushback);
    testOne("assign", test_assign);
    testOne("assign_iter", test_assign_iter);
    testOne("constr", test_constr);
    testOne("constr_iter", test_constr_iter);
    testOne("assign_copy", test_assign_copy);
    testOne("accessors", test_accessors);
    testOne("capacity", test_capacity);
    testOne("iterator", test_iterator);
    testOne("reverse_iterator", test_reverse_iterator);
    testOne("insert_one", test_insert_one);
    testOne("insert", test_insert);
    testOne("insert_iter", test_insert_iter);
    testOne("erase", test_erase);
    testOne("erase_range", test_erase_range);
    testOne("pop_back", test_pop_back);
    testOne("resize", test_resize);
    testOne("swap", test_swap);
    testOne("cmp_eq", test_cmp_eq);
}
