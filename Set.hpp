...
/*   Updated: 2020/08/10 19:38:38 by skybt            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    public:
        ...
        typedef typename AVLTree<Key, Compare, false>::iterator iterator;
        typedef typename AVLTree<Key, Compare, false>::const_iterator const_iterator;
        typedef ReverseIterator<iterator> reverse_iterator;
        typedef ReverseIterator<const_iterator> const_reverse_iterator;

    private:
        typedef AVLTree<Key, Compare, false> _tree_type;
        typedef Set<Key, Compare> _Self;
